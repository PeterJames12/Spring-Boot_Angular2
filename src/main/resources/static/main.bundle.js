...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_user_user_component__ = __webpack_require__("../../../../../src/app/pages/user/user.component.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__pages_user_user_component__["a" /* UserComponent */]
        ],
        imports: [
...
module.exports = "\n\n<div *ngIf=\"users\" align=\"center\">\n  <div style=\"margin-top: 200px; width: 550px\">\n    <div *ngFor=\"let user of users\" class=\"list-group\">\n      <a href=\"#\" class=\"list-group-item list-group-item-action\">{{user.id + ' : '}} {{user.email + ' : '}} {{user.name}}</a>\n    </div>\n  </div>\n</div>\n"
...
var UserComponent = (function () {
    ...
    UserComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userService.getAll().subscribe(function (s) {
            _this.users = s;
        });
    };
    UserComponent.prototype.print = function () {
...
var UserService = (function () {
    ...
    UserService.prototype.getAll = function () {
        return this.http.get(url + "/all/").map(function (res) { return res.json(); });
    };
